...
public class VoiceMuteCommand extends CommandBase {

    public VoiceMuteCommand(ControlBansPlugin plugin) {
        super(plugin);
        setCommand("voicemute");
    }

    @Override
    public boolean execute(CommandSender sender, String[] args) {
        if (!sender.hasPermission("controlbans.voicemute")) {
